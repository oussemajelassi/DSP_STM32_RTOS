...
/* Definitions for ADC_ReadingTASK */
osThreadId_t ADC_ReadingTASKHandle;
const osThreadAttr_t ADC_ReadingTASK_attributes = {
  .name = "ADC_ReadingTASK",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for DSP_Task */
osThreadId_t DSP_TaskHandle;
...
void vADC_Reading(void *argument);
...
/* USER CODE END Boot_Mode_Sequence_2 */
  ...
  /* Create the thread(s) */
  /* creation of ADC_ReadingTASK */
  ADC_ReadingTASKHandle = osThreadNew(vADC_Reading, NULL, &ADC_ReadingTASK_attributes);

  /* creation of DSP_Task */
  DSP_TaskHandle = osThreadNew(vDSP_fft, NULL, &DSP_Task_attributes);
...
/* USER CODE BEGIN Header_vADC_Reading */
/**
  * @brief  Function implementing the ADC_ReadingTASK thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_vADC_Reading */
void vADC_Reading(void *argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
...
/* USER CODE BEGIN Header_vDSP_fft */
/**
* @brief Function implementing the DSP_Task thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_vDSP_fft */
void vDSP_fft(void *argument)
{
  /* USER CODE BEGIN vDSP_fft */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END vDSP_fft */
}
