...
void DSP_InputBuffer_Init ( uint32_t size  )
{
	...
	{
		DSP_INPUT_BUFFER [ counter ] = 100 + ( 100 * arm_sin_f32( (float32_t) ( 3.14159 / 180 ) * counter ) ) ;
	}
...
void vDSP_SignalGenerate ( void * argument)
{
	DSP_SignalSpecs DSP_CurrentSignalSpecs ;
	uint32_t TIM_ARR = 0 ;
	DSP_SignalGenerationState DSP_SignalGenerationCurrentState = DSP_SignalGenerationStateIDLE ;
